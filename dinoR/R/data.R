...
#' To reduce file size, rows of the nomeR output were filtered to contain 30-80 fragments.
#'
#' @format ## `NomeMatrix`
#' A tibble with 717 rows and 4 columns:
#' \describe{
...
#'
#' @return A tibble with 717 rows and 4 columns
"NomeMatrix"
